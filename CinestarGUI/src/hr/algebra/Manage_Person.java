 ...
 * @author zvoni
 */
public class Manage_Person extends javax.swing.JFrame {
     ...
     */
    public Manage_Person() throws Exception {
        initComponents();
        init();
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (rbActor.isSelected() && rbDirector.isSelected()) {
            try {
                ...
                Logger.getLogger(Manage_Person.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                ...
                Logger.getLogger(Manage_Person.class.getName()).log(Level.SEVERE, null, e);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manage_Person.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Manage_Person().setVisible(true);
                } catch (Exception e) {
                    Logger.getLogger(Manage_Person.class.getName()).log(Level.SEVERE, null, e);
                }
            }
