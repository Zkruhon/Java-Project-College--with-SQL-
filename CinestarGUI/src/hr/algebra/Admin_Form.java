...
import hr.algebra.model.MovieArchives;
import hr.algebra.model.Genre;
import hr.algebra.parsers.rss.CinePars;
...
public class Admin_Form extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jList, javax.swing.GroupLayout.DEFAULT_SIZE, 720, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
       ...
       try {
            List<Movie> movies = CinePars.parse();
            List<Director> directors = new ArrayList<>();
            List<Actor> actors = new ArrayList<>();
            List<Genre> genres = new ArrayList<>();
            repository.createMovies(movies);
            List<Movie> filmsWithActors = new ArrayList<>();
            ...
            for (Movie movie : filmsWithActors) {
            ...
            List<Movie> movieWithoutNull = new ArrayList<>();
            ...
            List<Movie> filmsFromSQL = repository.selectMovies();
    ...
    private void loadModel() throws Exception {
        List<Movie> filmovi = repository.selectMovies();
        moviesModel.clear();
    ...
    private void initXML(List<Movie> movies) {
         List<Movie> xmlFilms = new ArrayList<>();
             if (movies != null) {
                    movies.forEach(a -> xmlFilms.add(a));
              }
            
            try {
            JAXBUtils.save(new MovieArchives(xmlFilms),FILENAME);
